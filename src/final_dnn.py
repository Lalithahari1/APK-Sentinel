...
MODEL_PATH = BASE_DIR / "models" / "final_dnn_model.keras"

MODEL_PATH.parent.mkdir(parents=True, exist_ok=True)

print("=" * 60)
print("PHASE 7B - FINAL DNN TRAINING")
print("=" * 60)
...
y_val = y_val.astype("int32").values
