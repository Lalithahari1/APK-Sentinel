...
def add_history(result, digest):
    entry = {
        ...
        "risk_level": level_for_ui(result.get("risk_level") or risk_level(result.get("risk_score", 0))),
...
def security_view(result):
    ...
    level = level_for_ui((result or {}).get("risk_level") or risk_level(score))
...
def answer_ai_question(question, result, ai):
    ...
    level = level_for_ui(result.get("risk_level") or risk_level(score))
